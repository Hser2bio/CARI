...
class ListReceivedTest (PivxTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 CARI.
        ...
        # Send 1 CARI to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 CARI sending them all (fee is 0.1 CARI)
        ...
        # Confirm transaction (2 CARI from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 CARI, send 0.6 CARI + 0.05 CARI fee
