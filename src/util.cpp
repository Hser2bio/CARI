...
const char * const CARI_CONF_FILENAME = "cari.conf";
const char * const CARI_PID_FILENAME = "cari.pid";
const char * const CARI_MASTERNODE_CONF_FILENAME = "masternode.conf";
